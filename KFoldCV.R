...
my_fo <- m1_binaryoutcome ~ mean.Miserable.2+var.Miserable.2+mean.Hopelessness.2+var.Hopelessness.2+mean.Duration_Combined.2+var.Duration_Combined.2
my_fo <- m1_binaryoutcome ~ mean.Miserable.2+var.Miserable.2+mean.Hopelessness.2+var.Hopelessness.2
my_fo <- m1_binaryoutcome ~ mean.Miserable.2+var.Miserable.2+mean.Duration_Combined.2+var.Duration_Combined.2
my_fo <- m1_binaryoutcome ~ mean.Hopelessness.2+var.Hopelessness.2+mean.Duration_Combined.2+var.Duration_Combined.2

my_fo <- m1_binaryoutcome ~ mean.Miserable.2+var.Miserable.2+mean.Duration_Combined.2+var.Duration_Combined.2
my_fo <- m1_binaryoutcome ~ mean.Hopelessness.2+var.Hopelessness.2+mean.Self_Efficacy.2+var.Self_Efficacy.2
my_fo <- m1_binaryoutcome ~ mean.Miserable.2+mean.Self_Efficacy.2+mean.Duration_Combined.2
my_fo <- m1_binaryoutcome ~ mean.Self_Efficacy.2+mean.Duration_Combined.2
my_fo <- m1_binaryoutcome ~ mean.Miserable.2+mean.Self_Efficacy.2
...
all.holdout.AUC <- colMeans(store.holdout.AUC)
